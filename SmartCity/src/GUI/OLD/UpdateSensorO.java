 ...
 */
public class UpdateSensorO extends javax.swing.JFrame {

    /**
     * Creates new form AddSensor
     */
    public UpdateSensorO() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSensorO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateSensorO().setVisible(true);
            }
        });
    }
